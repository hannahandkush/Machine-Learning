...
Remote sensing / geospatial image classification, burned area mapping & binary semantic segmentation ("other: satellite time-series burned area detection"; closest standard categories: *image segmentation*, *binary classification*)
